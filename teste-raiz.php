...
renderHeader("Teste do Sistema (Raiz)", "Verificação de funcionalidades", [
    'icon' => 'fas fa-cog',
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white rounded-lg shadow-lg p-6">
        <h2 class="text-2xl font-bold mb-4">Teste do Sistema (Executado da Raiz)</h2>
        ...
        <div class="space-y-4">
            ...
            <div class="p-4 rounded-lg bg-gray-100">
                ...
                <div class="space-y-2">
                    <a href="index.php" class="btn-custom btn-primary">Dashboard</a>
                    <a href="pages/eventos.php" class="btn-custom btn-success">Ir para Eventos</a>
                    <a href="pages/candidaturas.php" class="btn-custom btn-warning">Ir para Candidaturas</a>
                    <a href="pages/teste.php" class="btn-custom btn-secondary">Teste de Subpasta</a>
                </div>
            </div>
        </div>
    </div>
