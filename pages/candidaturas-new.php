...
renderHeader("Gerenciar Candidaturas", "Visualize e gerencie inscrições recebidas via QR Code");
?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div id="loading" class="hidden text-center">
        <div class="inline-block animate-spin rounded-full h-6 w-6 border-b-2 border-azul-claro"></div>
        <span class="ml-2 text-cinza-medio">Carregando candidaturas...</span>
    </div>
